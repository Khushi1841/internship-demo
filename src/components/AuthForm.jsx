...
const AuthForm = ({ onAuthSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        // Direct Login
        const res = await fetch('https://internship-demo-1.onrender.com/api/auth/login', {
          method: 'POST',
        ...
        // Signup requires OTP
        const res = await fetch('https://internship-demo-1.onrender.com/api/auth/request-otp', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
